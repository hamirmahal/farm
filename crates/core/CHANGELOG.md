...
## [0.7.0](https://github.com/hamirmahal/farm/compare/farmfe_core-v0.6.4...farmfe_core-v0.7.0) - 2024-10-13

### Added

- *(css)* support css module name coversion ([#1784](https://github.com/hamirmahal/farm/pull/1784))
- support resolve dedupe ([#1762](https://github.com/hamirmahal/farm/pull/1762))
...
- preset_env plugin match and module system `analyze` ([#1751](https://github.com/hamirmahal/farm/pull/1751))
