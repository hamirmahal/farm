...
## [0.1.3](https://github.com/hamirmahal/farm/compare/create_farm_node-v0.1.2...create_farm_node-v0.1.3) - 2024-10-13

### Other

- Version Packages ([#1722](https://github.com/hamirmahal/farm/pull/1722))
- Version Packages ([#1703](https://github.com/hamirmahal/farm/pull/1703))
- *(create-farm)* add multiple platforms ([#1689](https://github.com/hamirmahal/farm/pull/1689))
